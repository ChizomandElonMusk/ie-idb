...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/dashboard.vue?vue&type=template&id=524b533c&scoped=true
var render = function render() {
  ...
  return _c('div', {
  ...
  }, [_vm._ssrNode("<div class=\"flexcontainer\" style=\"margin-top: 10px;\" data-v-524b533c>", "</div>", [_vm._ssrNode("<div class=\"flexitem-username\" data-v-524b533c><b style=\"font-size: 20px; color: #757575;\" data-v-524b533c>" + _vm._ssrEscape("\n        " + _vm._s(_vm.greeting) + "\n      ") + "</b> <br data-v-524b533c></div> "), _vm._ssrNode("<div class=\"flexitem-notification\" data-v-524b533c>", "</div>", [_c('nuxt-link', {
    attrs: {
      "to": "/settings"
    }
  }, [_c('img', {
  ...
  })])], 1)], 2), _vm._ssrNode(" <div class=\"row\" data-v-524b533c><b class=\"grey-text darken-4\" data-v-524b533c>" + _vm._ssrEscape("\n      " + _vm._s(_vm.account_name) + "\n    ") + "</b> <br data-v-524b533c> <div class=\"card-panel red\" style=\"border-radius: 10px;\" data-v-524b533c><div class=\"flexcontainerinfo\" data-v-524b533c><div" + _vm._ssrClass("white-text flex-icon-day", {
    'hide': _vm.defaultData
  }) + " data-v-524b533c>" + (_vm.online_status == 'online' ? "<img" + _vm._ssrAttr("src", __webpack_require__(58)) + " alt class=\"responsive-img\" style=\"max-width: 50px;\" data-v-524b533c>" : "<!---->") + " " + (_vm.online_status == 'offline' ? "<img" + _vm._ssrAttr("src", __webpack_require__(59)) + " alt class=\"responsive-img\" style=\"max-width: 50px;\" data-v-524b533c>" : "<!---->") + "</div> <div" + _vm._ssrClass("flex-time", {
    'hide': _vm.defaultData
  }) + " data-v-524b533c><span class=\"white-text\" style=\"font-size: 12px;\" data-v-524b533c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.dashboard_date) + "\n          ") + "</span> <br data-v-524b533c> <span class=\"white-text\" style=\"font-weight: 600; font-size: 10px;\" data-v-524b533c>\n            Account number:\n          </span> <br data-v-524b533c> <span class=\"white-text\" style=\"font-weight: 300; font-size: 12px;\" data-v-524b533c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.account_number) + "\n          ") + "</span> <br data-v-524b533c> <span class=\"white-text\" style=\"font-weight: 600; font-size: 10px;\" data-v-524b533c>\n            Meter number:\n          </span><br data-v-524b533c> <span class=\"white-text\" style=\"font-weight: 300; font-size: 12px;\" data-v-524b533c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.meter_number) + "\n          ") + "</span></div> <div" + _vm._ssrClass("flex-temperature", {
    'hide': _vm.defaultData
  }) + " data-v-524b533c><b style=\"background-color: yellow; padding: 5px; border-radius: 10px;\" data-v-524b533c>Band:</b> <br data-v-524b533c> <span class=\"white-text\" style=\"font-size: 20px;\" data-v-524b533c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.getFirstLetter(_vm.tariff)) + "\n          ") + "</span></div> <div" + _vm._ssrClass("flex-time center", {
    'hide': _vm.energyBalance
  }) + " data-v-524b533c><p class=\"white-text\" style=\"font-size: 22px;\" data-v-524b533c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.energy_balance_data) + "\n          ") + "</p> <img" + _vm._ssrAttr("src", __webpack_require__(60)) + " alt class=\"responsive-img\" style=\"max-width: 30px;\" data-v-524b533c></div></div> <div class=\"flexcontainerinfo\" style=\"margin-top: 5px;\" data-v-524b533c><div class=\"white-text flex-meter-number\" data-v-524b533c></div></div></div></div> "), _vm._ssrNode("<div class=\"row\" data-v-524b533c>", "</div>", [_vm._ssrNode("<div class=\"flexcontainerbtn\" data-v-524b533c>", "</div>", [_vm._ssrNode("<div class=\"card-panel orange flex-buttons\" style=\"border-radius: 10px;\" data-v-524b533c><div class=\"white-text center boarder-top\" data-v-524b533c><img" + _vm._ssrAttr("src", __webpack_require__(46)) + " alt class=\"responsive-img\" style=\"max-width: 50px; filter: hue-rotate(180deg);\" data-v-524b533c> <p class=\"button-text white-text\" data-v-524b533c>\n            Energy Balance\n          </p></div></div> <div style=\"width: 10px;\" data-v-524b533c></div> "), _vm._ssrNode("<div class=\"card-panel orange flex-buttons\" style=\"border-radius: 10px;\" data-v-524b533c>", "</div>", [_vm._ssrNode("<div class=\"white-text center boarder-top\" data-v-524b533c>", "</div>", [_c('nuxt-link', {
    attrs: {
      "to": "./trans_history"
    }
  }, [_c('img', {
  ...
  }, [_vm._v("\n              Transaction History\n            ")])])], 1)])], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-524b533c>", "</div>", [_vm._ssrNode("<div class=\"flexcontainerbtn\" data-v-524b533c>", "</div>", [_vm._ssrNode("<div class=\"card-panel orange flex-buttons\" style=\"border-radius: 10px;\" data-v-524b533c><a href=\"https://www.ie-payments.com/pay-bill\" target=\"_blank\" data-v-524b533c><div class=\"white-text center boarder-top\" data-v-524b533c><img" + _vm._ssrAttr("src", __webpack_require__(48)) + " alt class=\"responsive-img\" style=\"max-width: 50px; filter: hue-rotate(180deg);\" data-v-524b533c> <p class=\"button-text white-text\" data-v-524b533c>\n              Purchase Electricity\n            </p></div></a></div> <div style=\"width: 10px;\" data-v-524b533c></div> "), _vm._ssrNode("<div class=\"card-panel orange flex-buttons\" style=\"border-radius: 10px;\" data-v-524b533c>", "</div>", [_vm._ssrNode("<div class=\"white-text center boarder-top\" data-v-524b533c>", "</div>", [_c('nuxt-link', {
    attrs: {
      "to": "./remote"
    }
  }, [_c('img', {
    ...
    staticClass: "button-text white-text"
  }, [_vm._v("\n              Remote Loading\n            ")])])], 1)])], 2)]), _vm._ssrNode(" <div class=\"row\" data-v-524b533c><div class=\"card-panel red\" style=\"border-radius: 10px;\" data-v-524b533c><div class=\"center\" data-v-524b533c><h4 class=\"white-text\" data-v-524b533c>\n          Ads\n        </h4> <b class=\"white-text\" style=\"font-size: 20px; font-weight: 700;\" data-v-524b533c>\n          ...\n        </b></div></div></div>")], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/dashboard.vue?vue&type=template&id=524b533c&scoped=true
