...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/confirm_otp_reset_password.vue?vue&type=template&id=81cebefc&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
// CONCATENATED MODULE: ./pages/confirm_otp_reset_password.vue?vue&type=template&id=81cebefc&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/confirm_otp_reset_password.vue?vue&type=script&lang=js&


/* harmony default export */ var confirm_otp_reset_passwordvue_type_script_lang_js_ = ({
  data() {
    return {
      user_otp: '',
      hidePreLoader: true,
  ...
  methods: {
    async sendOtp() {
      ...
      if (this.user_otp == '') {
        ...
        let response = await Object(mods["c" /* confirmPasswordResetToken */])(this.user_otp);
        if (response == undefined || response.message == 'Invalid reset operation detected!') {
          M.toast({
            html: '<b class="red-text">Invalid reset operation detected!</b>'
          });
...
// CONCATENATED MODULE: ./pages/confirm_otp_reset_password.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_confirm_otp_reset_passwordvue_type_script_lang_js_ = (confirm_otp_reset_passwordvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/confirm_otp_reset_password.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_confirm_otp_reset_passwordvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var confirm_otp_reset_password = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=confirm_otp_reset_password.js.map