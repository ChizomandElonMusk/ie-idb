...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"row\" style=\"margin-top: 0px\"><div class=\"col s12 m3\"></div> <div class=\"col s12 m6 center\"><img" + _vm._ssrAttr("src", __webpack_require__(34)) + " alt class=\"responsive-img circle\" style=\"max-width:100px; max-height:100px\"></div> <div class=\"col s12 m3\"></div></div>")]);
};
var staticRenderFns = [];
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/signup.vue?vue&type=template&id=1a2086d5&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"row full-width\">", "</div>", [_vm._ssrNode("<div class=\"col s12 m6\" style=\"margin-top: 40px\">", "</div>", [_c('Logo'), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col s12\"></div> "), _vm._ssrNode("<div class=\"col s12\">", "</div>", [_vm._ssrNode("<div class=\"white darken-4\">", "</div>", [_vm._ssrNode("<div class=\"card-content\">", "</div>", [_vm._ssrNode("<h6 class=\"center black-text\" style=\"font-weight:500;\">\n                          Hi, Welcome\n                      </h6> <p class=\"center\" style=\"font-weight:500;\">\n                          Kindly fill out your information to get you started.\n                      </p> "), _vm._ssrNode("<form>", "</form>", [_vm._ssrNode("<div class=\"row\"><div class=\"input-field col s12\"><input type=\"text\" placeholder id=\"firstname\" class=\"black-text\"> <label for=\"firstname\">First Name</label></div></div> <div class=\"row\"><div class=\"input-field col s12\"><input type=\"text\" placeholder id=\"lastname\" class=\"black-text\"> <label for=\"lastname\">Last Name</label></div></div> <div class=\"row\"><div class=\"input-field col s12\"><input type=\"text\" placeholder id=\"email\" class=\"black-text\"> <label for=\"email\">Email</label></div></div> <div class=\"row\"><div class=\"input-field col s12\"><input type=\"text\" placeholder id=\"phonenumber\" class=\"black-text\"> <label for=\"phonenumber\">Phone Number</label></div></div> <div class=\"row\"><div class=\"input-field col s12\"><input type=\"password\" placeholder id=\"password\" class=\"black-text\"> <label for=\"password\">Password</label></div></div> <div class=\"row\"><div class=\"input-field col s12\"><input type=\"password\" placeholder id=\"confirmpassword\" class=\"black-text\"> <label for=\"confirmpassword\">Confirm Password</label></div></div> "), _vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"input-field\"><button class=\"customButtonColor btn btn-large col s12 red\">\n                                      Create Account\n                                  </button></div> "), _vm._ssrNode("<div class=\"col s12 center\" style=\"margin-top: 10px;\">", "</div>", [_vm._ssrNode("\n                                  I already have an account? "), _c('nuxt-link', {
  ...
  }, [_vm._v("Login")])], 2)], 2)], 2)], 2)])])], 2)])], 2), _vm._ssrNode(" <div class=\"col s12 m6 full-width hide-on-small-and-down\"" + _vm._ssrStyle(null, {
    backgroundImage: `url(${_vm.backgroundUrl})`
  }, null) + "></div>")], 2)]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/signup.vue?vue&type=template&id=1a2086d5&

// EXTERNAL MODULE: ./assets/images/angled_background.jpg
var angled_background = __webpack_require__(36);
