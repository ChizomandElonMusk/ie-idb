...
var render = function render() {
  ...
  return _c('div', {
    ...
    return "<tbody" + _vm._ssrAttr("id", trans.orderNo) + "><tr><td><a href=\"#!\">" + _vm._ssrEscape("\n                        " + _vm._s(index + 1) + "\n                      ") + "</a></td> <td>" + _vm._ssrEscape("₦" + _vm._s(_vm.formatCurrency(trans.amount))) + "</td> <td>" + _vm._ssrEscape(_vm._s(_vm.formatDateToString(trans.transactionDate))) + "</td> <td><img" + _vm._ssrAttr("src", __webpack_require__(64)) + " alt class=\"responsive-img\" style=\"max-width: 30px;\"></td></tr></tbody>";
  }) + "</table></div></div>")], 2);
};
var staticRenderFns = [];
...
var Chart = __webpack_require__(65);
