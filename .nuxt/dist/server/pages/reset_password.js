...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/reset_password.vue?vue&type=template&id=01a04198
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"row full-width\">", "</div>", [_vm._ssrNode("<div class=\"col s12 m6\" style=\"margin-top: 130px\">", "</div>", [_c('Logo'), _vm._ssrNode(" <div class=\"container\"><div class=\"row\"><h5 class=\"center red-text\">\n              IDB\n            </h5> <div" + _vm._ssrClass("row", {
    'hide': _vm.hidePreLoader
  }) + "><div class=\"col s12 center\"><img" + _vm._ssrAttr("src", __webpack_require__(37)) + " class=\"responsive-img heartbeat\" style=\"max-width: 60px;\"></div></div></div> <form><div class=\"row\"><div class=\"input-field col s12\"><input type=\"password\" placeholder=\"New password\" id=\"_newpassword\"" + _vm._ssrAttr("value", _vm.new_password) + " class=\"black-text\"> <label for=\"new_password\">New Password</label></div></div> <div class=\"row\"><div class=\"input-field col s12\"><input type=\"password\" placeholder=\"Confirm password\" id=\"confirm_password\"" + _vm._ssrAttr("value", _vm.confirm_password) + " class=\"black-text\"> <label for=\"confirm_password\">Confirm Password</label></div></div> <div class=\"row\"><div class=\"input-field col s12 center\"><button class=\"red btn btn-large col s12\" style=\"border-radius: 10px 10px 10px 10px;\">\n                          Proceed\n                      </button></div></div></form></div>")], 2), _vm._ssrNode(" <div class=\"col s12 m6 full-width hide-on-small-and-down\"" + _vm._ssrStyle(null, {
    backgroundImage: `url(${_vm.backgroundUrl})`
  }, null) + "></div>")], 2)]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/reset_password.vue?vue&type=template&id=01a04198
...
var PreLoader = __webpack_require__(43);
