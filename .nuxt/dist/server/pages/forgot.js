...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/forgot.vue?vue&type=template&id=03ffc7c2
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
// CONCATENATED MODULE: ./pages/forgot.vue?vue&type=template&id=03ffc7c2
...
/* harmony default export */ var forgotvue_type_script_lang_js = ({
  ...
  methods: {
    async confirmUsername() {
      ...
      if (this.username == '') {
        M.toast({
          html: '<b class="yellow-text">Please enter a valid username</b>'
        });
      } else {
        let token = await Object(mods["k" /* passwordResetIntent */])(this.username);
        if (token == undefined || token.message == 'Invalid user details supplied!') {
          M.toast({
            html: '<b class="red-text">Invalid user details supplied!</b>'
          });
